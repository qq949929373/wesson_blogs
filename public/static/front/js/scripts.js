...
//图片延时加载
$("img.thumb").lazyload({
    placeholder: "/static/front/images/occupying.png",
    effect: "fadeIn"
});
...
// 	next: '.next-page a',
// 	trigger: '查看更多',
// 	loader: '<div class="pagination-loading"><img src="/static/front/images/loading.gif" /></div>',
...
$(function () {
    ...
    $("#comment-submit").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "/front/index/saveBlogsComment",
            data: {
...
function replace_em(str) {
    str = str.replace(/\</g, '&lt;');
    str = str.replace(/\>/g, '&gt;');
    str = str.replace(/\[em_([0-9]*)\]/g, '<img src="' + imageUrl + 'arclist/$1.gif" border="0" />');
    return str;
}
